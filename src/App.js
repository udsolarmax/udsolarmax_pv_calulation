          ...
          {Array.from({ length: stringCount }).map((_, sIdx) => {
            ...
            return (
              <g key={sIdx}>
                ...
                <rect x={xOff + currentW * 0.25} y="0" width="45" height={railLenMM} fill="#94a3b8" rx="10" />
                <rect x={xOff + currentW * 0.75} y="0" width="45" height={railLenMM} fill="#94a3b8" rx="10" />
                
                {/* เส้นบอกระยะรางรวม */}
                <line x1={xOff - 250} y1="0" x2={xOff - 250} y2={railLenMM} stroke="#fbbf24" strokeWidth="20" />
                <text x={xOff - 380} y={railLenMM/2} fill="#fbbf24" fontSize="220" fontWeight="bold" textAnchor="middle" transform={`rotate(-90, ${xOff - 380}, ${railLenMM/2})`}>รางรวม: {results.totalRailLength} ม.</text>
